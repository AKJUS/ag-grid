...
For code quality guidelines, see [Code Quality Guide](external/ag-shared/prompts/guides/code-quality.md).
...
For JIRA ticket guidelines, see [JIRA Guide](external/ag-shared/prompts/guides/jira.md).
